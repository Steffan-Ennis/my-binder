...
const IconSmall: FC = () => (
  <Svg width={28} height={28} viewBox="0 0 256 256">
    ...
    <Circle cx={153} cy={105} r={2.5} fill="rgba(245,225,180,0.85)" />
    <Circle cx={153} cy={150} r={2.5} fill="rgba(245,225,180,0.85)" />
    <Circle cx={153} cy={195} r={2.5} fill="rgba(245,225,180,0.85)" />
    <Rect
      x={35}
      y={180}
      width={100}
